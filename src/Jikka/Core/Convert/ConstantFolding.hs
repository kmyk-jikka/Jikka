...
rule =
  let return' = return . Just
   in RewriteRule $ \_ -> \case
        ...
        FloorDiv' (LitInt' a) (LitInt' b) | b /= 0 -> Just . LitInt' <$> floorDiv a b
        FloorMod' (LitInt' a) (LitInt' b) | b /= 0 -> Just . LitInt' <$> floorMod a b
        CeilDiv' (LitInt' a) (LitInt' b) | b /= 0 -> Just . LitInt' <$> ceilDiv a b
        CeilMod' (LitInt' a) (LitInt' b) | b /= 0 -> Just . LitInt' <$> ceilMod a b
